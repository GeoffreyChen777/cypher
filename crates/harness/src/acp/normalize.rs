...
use cypher_proto::{AgentEvent, SlashCommand, TodoItem, ToolCall, ToolDiff};
...
/// content) to the typed [`ToolCall`] cypher renders. Best-effort: agents vary
...
pub(crate) fn map_update(update: &Value) -> Vec<AgentEvent> {
    ...
    match kind {
        ...
        "plan" => {
            ...
            vec![
                AgentEvent::ToolCall {
                    id: cypher_proto::LIVE_PLAN_TOOL_ID.into(),
