...
//!
//! Cypher opts into parameterized mode. Auto's Intelligence / Balance / Cost
...
use cypher_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel};
...
/// Cypher can render — so callers put it on the description subline (or fold
...
/// Rewrite the wire model list into Cypher's picker shape.
...
/// Preference-ordered effort tokens for a Cypher reasoning pick, used when
