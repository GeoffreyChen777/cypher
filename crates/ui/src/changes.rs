...
pub struct DiffHighlights {
    pub old: Option<Arc<cypher_syntax::HighlightedDocument>>,
    pub new: Option<Arc<cypher_syntax::HighlightedDocument>>,
}
...
impl DiffHighlights {
    ...
    pub fn spans(&self, line: &DiffLine) -> &[cypher_syntax::HighlightSpan] {
...
fn sources_match_patch(file: &FileDiff, response: &cypher_proto::CheckoutFileDiffText) -> bool {
    let old = response
        .old_text
        .as_deref()
