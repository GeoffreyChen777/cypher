...
pub const PENDING_LINK_URL: &str = "cypher:pending-link";
...
pub fn close_hanging(text: &str) -> Option<String> {
    ...
    pending.sort_by_key(|(open, _)| std::cmp::Reverse(*open));
...
mod tests {
    ...
    fn links_mend_to_pending_sentinel() {
        mends("[docs](https://x.dev/lo", "[docs](cypher:pending-link)");
        mends("[docs](", "[docs](cypher:pending-link)");
        mends("see [do", "see [do](cypher:pending-link)");
        mends("![alt](https://x/i.p", "![alt](cypher:pending-link)");
        stays("see [");
    ...
    fn link_urls_allow_nested_parens() {
        ...
        mends("[a](https://x.dev/(y", "[a](cypher:pending-link)");
    }

    #[test]
    fn emphasis_inside_link_text_closes_inside() {
        mends("[**a", "[**a**](cypher:pending-link)");
        mends("**a [b", "**a [b](cypher:pending-link)**");
    }
